...
function about() {
	$(".coins-container").html("");
	$(".coins-container").append(
		`<div class="infoAboutMe"> <img class="picOfMe" src="img/eranPic.jpg" style="width:200px"/> 
		<p class="infoText"><h1>My name is Eran Samimian, I'm 31 years old. </h1>
		<br><h1>I am a web developer with high ambitions and passion for the </h1>
        profession.
		<br><h2> TECHINCAL SKILLS : </h2>
		<br> React
         /Redux
         /Javascript
         /Css
		...
		<br> 2022- Today
        Matrix - Full Stack Developer.
		<br> I worked as a fullstack developer at Matrix as part of the development team that develops advanced management software (ERP) that is adapted to mobile for the leading high-tech companies in Israel.
        In this work we created the ERP software in the code languages: JS, CSS, Scss, Chace, HTML, JQurey
        
        <br><h2>EDUCATION:</h2>
        <br>2020- 2022
        John Bryce College- Full Stack Web Developer
        <br>The course included the following areas of knowledge:
        Booking Full Stack System - HTML / Css / JavaScript / React / Redux / Angular TypeScript / MaterialUI / Node.js / Express / jwt / Ajax / Jquery / SQL / NoSQL / MongoDb / Regex / Docker / Bootstrap / sliced to Heroku.
        During my studies I developed a number of Full Stack projects, built the client side with react + redux, and the server side with nodeJs + express for the server API.
        In the course, I also learned how to write clean ES6 code and implement via best practices.
        
        <br>2006- 2009
        <br>Ort Harmats College
        <br>Computer science studies, 
        full matriculation.

        <br><h2>Military service:</h2>
        <br>2009- 2012
        Navy
        <br>I served on the computer team in the Navy Technology Unit

        <br><h2>hobbies and Characteristics:</h2>
        <br>Foremost, I am an artistic person who enjoys painting during my free time. Socially, I enjoy group and team sport activities with friends including frisbee, ping pong and basketball.

        <br><h2>For more projects please visit my Git account:</h2>
        <br><a href="https://github.com/eransam/">https://github.com/eransam/</a>


        <br><h2>Linkdin:</h2>
        <br><a href="https://www.linkedin.com/in/eran-samimian-6b897a233/">https://www.linkedin.com/in/eran-samimian-6b897a233/</a>
